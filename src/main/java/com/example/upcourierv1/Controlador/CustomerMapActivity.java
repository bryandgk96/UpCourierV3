...
public class CustomerMapActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    static CustomerMapActivity instance;
    private LocationBroadCastReceiver locationBroadCastReceiver;
    LocationUpdates locationUpdates;
    private GoogleMap mGoogleMap;
    SupportMapFragment supportMapFragment;
    private Button btnSalir, btnPedir;
    ...
    public static CustomerMapActivity getInstance(){return instance;}
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSalir = (Button) findViewById(R.id.btn_leaveC);
        ...
        btnPedir.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                pickUpLocation = new LatLng(lastLat,lastLong);
                mGoogleMap.addMarker(new MarkerOptions().position(pickUpLocation).title("Servicio en espera"));
            }
        });
    }
